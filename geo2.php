...
<br />
        <center> <font color="red" face="iceland" size="10">IP Geolocation</font>
		 <br /> <br />
<img src="https://cdn.pbrd.co/images/6RXeCi5n8.png" width="100" height="100">
<br /> <br />

		<form action="" id="form1" method="get" onsubmit=" location.href = 'https://extreme-ip-lookup.com/' + document.getElementById('url').value; return false; "> 
	
			<input type="text" name="url" value="36.81.59.25" id="url"/> 
